...
Package/luci-app-shadowsocksR-spec = $(call Package/openwrt-dist-luci/Default,shadowsocks-libev-spec)
...
Package/luci-app-shadowsocksR-spec/description = $(call Package/openwrt-dist-luci/description,shadowsocks-libev-spec)
...
Package/luci-app-shadowsocksR-spec/postinst = $(call Package/openwrt-dist-luci/postinst,shadowsocks)
...
Package/luci-app-shadowsocksR-spec/install = $(call Package/openwrt-dist-luci/install,$(1),shadowsocks)
...
$(eval $(call BuildPackage,luci-app-shadowsocksR-spec))
